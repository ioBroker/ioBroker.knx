...
module.exports = {
    ...
    getGAS : function(fileName, callback){
        var obj = [];
                        ...
                        for (var ixug = 0; ixug < ug_all.length; ixug++) {
                            ...
                            tmpobj = {
                                ...
                                common: {
                                    ...
                                    role: values.setRole,           // read-only: indicator.(light, alarm, alarm.water), indicator.motion
    ...
    getRoomFunctions : function(fileName, callback) {
        loadProjFile(fileName, function (err, knxMaster, xml0) {
